...
def generate():
    try:
        ...
        focus_map = {
            "General": "సంపూర్ణ జాతక విశ్లేషణ — అన్ని 7 sections వివరంగా ఇవ్వాలి",
            "Career": "కేవలం వృత్తి/వ్యాపారం గురించి మాత్రమే వివరంగా చెప్పాలి — మిగిలిన sections సంక్షిప్తంగా",
            "Finance": "కేవలం ఆర్థిక స్థితి గురించి మాత్రమే వివరంగా చెప్పాలి",
            "Marriage": "కేవలం వివాహం/జీవిత భాగస్వామి గురించి మాత్రమే వివరంగా చెప్పాలి",
            "Health": "కేవలం ఆరోగ్యం గురించి మాత్రమే వివరంగా చెప్పాలి",
            "Personality": "కేవలం వ్యక్తిత్వం గురించి మాత్రమే వివరంగా చెప్పాలి",
            "Education": "కేవలం విద్య/చదువు గురించి మాత్రమే వివరంగా చెప్పాలి",
            "Family": "కేవలం కుటుంబం గురించి మాత్రమే వివరంగా చెప్పాలి",
            "Social": "కేవలం సామాజిక స్థాయి/నాయకత్వం గురించి మాత్రమే వివరంగా చెప్పాలి",
            "Spiritual": "కేవలం ఆధ్యాత్మికం గురించి మాత్రమే వివరంగా చెప్పాలి",
        }
        focus_instruction = focus_map.get(focus, focus_map["General"])
        full_prompt = full_prompt + f"\n\n⚠️ FOCUS INSTRUCTION: {focus_instruction}"
